...
const quotes = [
    {content: "It is not the mountians ahead that will wear you out, it is the pebble in your shoe", author: "Muhammed Ali"},
...
app.get("/api/hello", (req, res)=>{
    res.json({msg: "hello world! Wazzaaaaa!!!"})
})


//get request to get all the qoute
app.get("/api/quotes", (req, res)=>{
    res.json({count: quotes.length, results: quotes})
})

//get one qoute based on index
...
app.delete("/api/quotes/:idx", (req, res)=>{
    //the index of the quote we want to delete is req.params.idx
